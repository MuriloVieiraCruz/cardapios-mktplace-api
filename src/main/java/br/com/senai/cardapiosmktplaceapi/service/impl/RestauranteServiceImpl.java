...
public class RestauranteServiceImpl implements RestauranteService{
	...
	@Override
	public Page<Restaurante> listarPor(String nome, Categoria categoria, Pageable page) {
		return this.repository.listarPor("%" + nome + "%", categoria, page);
	}
	...
	public Restaurante excluirPor(Integer id) {
		...
		Preconditions.checkArgument(qtdeDeCardapiosVinculados == 0,
				"Não é possivel remover pois existem cardapios vinculados");
